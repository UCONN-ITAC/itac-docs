...
LaTeX seems overwhelming at first for basically everyone. It looks like you're writing code instead of your document. However, it's actually a lot easier than it seems. We use overleaf to compose all of our reports, which is a cloud-based LaTeX environment. 
